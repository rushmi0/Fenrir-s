...
sealed class RelayResponse<out T> {
    ...
    /**
     * `AUTH` (relay -> client) ใช้ส่ง challenge string ให้ไคลเอนต์เซ็นชื่อกลับมาเพื่อยืนยันตัวตนตาม NIP-42
     * @param challenge challenge string แบบสุ่มที่ผูกกับ session นี้
     */
